...
export type GetContentQuery = { __typename?: 'Query', getContent: { __typename?: 'ContentsDefine', id: DataId, datasourceId: string, parentId?: DataId | null, values: ContentValueMap, usingOtherMap: boolean, anotherMapItemId?: DataId | null, readonly?: boolean | null, hasValue: boolean, hasImage: boolean, linkedContents: Array<DataId> } };
