...
export type GetCategoryQuery = { __typename?: 'Query', getCategory: Array<{ __typename?: 'CategoryDefine', datasourceId: string, fieldKey: string, categories: Array<{ __typename?: 'CategoryItem', name: string, color: string }> }> };
