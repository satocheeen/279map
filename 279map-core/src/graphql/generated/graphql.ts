...
export type GetContentQuery = { __typename?: 'Query', getContent: { __typename?: 'ContentsDefine', id: DataId, parentId?: DataId | null, values: ContentValueMap, usingAnotherMap: boolean, anotherMapItemId?: DataId | null, isEditable: boolean, isDeletable: boolean, hasValue: boolean, hasImage: boolean } };
...
export type GetContentsQuery = { __typename?: 'Query', getContents: Array<{ __typename?: 'ContentsDefine', id: DataId, parentId?: DataId | null, values: ContentValueMap, usingAnotherMap: boolean, anotherMapItemId?: DataId | null, isEditable: boolean, isDeletable: boolean, hasValue: boolean, hasImage: boolean }> };
...
export type GetContentsInItemQuery = { __typename?: 'Query', getContentsInItem: Array<{ __typename?: 'ContentsDefine', id: DataId, parentId?: DataId | null, values: ContentValueMap, usingAnotherMap: boolean, anotherMapItemId?: DataId | null, isEditable: boolean, isDeletable: boolean, hasValue: boolean, hasImage: boolean, children?: Array<{ __typename?: 'ContentsDefine', id: DataId, parentId?: DataId | null, values: ContentValueMap, usingAnotherMap: boolean, anotherMapItemId?: DataId | null, isEditable: boolean, isDeletable: boolean, hasValue: boolean, hasImage: boolean }> | null }> };

export type ContentFragment = { __typename?: 'ContentsDefine', id: DataId, parentId?: DataId | null, values: ContentValueMap, usingAnotherMap: boolean, anotherMapItemId?: DataId | null, isEditable: boolean, isDeletable: boolean, hasValue: boolean, hasImage: boolean };
